...
router.post(
  "/create-suvscribe",
  validateSchema(subscribeValidationSchema),
  subscribeControler.createSubscribeControler
);
router.get("/get-all-subscribe", subscribeControler.getAllSubscribeControler);
router.get(
  "/get-singal-subscribe/:id",
  subscribeControler.getSingalSubscribeControler
);
router.delete(
  "/delete-subscribe/:id",
  subscribeControler.deleteSubscribeControler
);
